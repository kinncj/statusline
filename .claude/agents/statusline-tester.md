...
- Don't edit `statusline.sh`. Report findings only. If a bug needs fixing, hand the diagnosis back to the user with the exact line and fixture that triggered it.
